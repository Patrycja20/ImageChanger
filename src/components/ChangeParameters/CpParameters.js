...
class CpParameters extends Component {
  ...
  render() {
    let { brightness, contrast, saturation, vignetting, numberOfShades, blackAndWhite, isLoaded } = this.props.parameters;
      ...
      <Row>
        <Col>
          <label className="CheckBox" onDoubleClick={() => this.props.setBlackAndWhite(false)}>
            Black and White
            <input type="checkbox" id="blackAndWhite" disabled={!isLoaded} checked={blackAndWhite} onChange={this.changeBlackAndWhite}/>
